...
*
*/
public class NewHBaseTest extends HBaseClusterTestCase {
...
//      new HBaseScheme(), output, SinkMode.APPEND);
  ...
  // Helpers
  protected void verifySource(Flow flow, int expects)
  throws IOException {
    int count = 0;
  ...
  protected void verifySink(Flow flow, int expects)
  throws IOException {
